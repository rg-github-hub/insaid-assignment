export default function SideNavbar(){
    return <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0" id="sidebar" role="navigation" style={{backgroundColor:"#e9ecef"}}>
    <ul className="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 ">
        <li className="nav-item mb-2 mt-3"><a className="nav-link text-secondary" href="/"><h5>Jacob Nejam</h5></a></li>
        <li className="nav-item mb-2 "><a href="/dashboard" className="nav-link text-secondary" ><i className="fas fa-user font-weight-bold"></i> <span className="ml-3">Create New User</span></a></li>
