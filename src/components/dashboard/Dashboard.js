   ...
   useEffect(() => {
    ...
    <div className="col main pt-5 mt-3">
        ...
        <div className="card-columns mb-3">
            ...
            <div className="card">
                <img className="card-img img-fluid" src="//placehold.it/600x200/777/fff?text=..." alt="Card"/>
            </div>
                    ...
                    <div id="tabsJustifiedContent" className="tab-content">
                        ...
                        <div className="tab-pane active" id="tab2">
                            <div className="row">
                                ...
                                <div className="col-sm-5"><img src="//placehold.it/170" className="float-right img-responsive img-rounded" alt='not available'/></div>
                            </div>
                            <hr/>
